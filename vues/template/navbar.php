                    ...
                    <ul class = "nav navbar-nav">
                        ...
                        <li class="dropdown nav-item <?php if($page===2) { ?>active <?php } ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li role="presentation" class="dropdown-item">
                                    <a role="menuitem" href="../../pages/C_seeulater.php">Prochain projet</a>
                                </li>
                                <li role="presentation" class="dropdown-item">
                                    <a role="menuitem" href="../../pages/C_seeulater.php">Projet d'après</a>
                                </li>
                                <li role="presentation" class="dropdown-divider"></li>
                                <li role="presentation" class="dropdown-header dropdown-item">
                                    En entreprise</li>
                                <li role="presentation" class="dropdown-item">
                                    <a role="menuitem" href="../../pages/C_seeulater.php">Projet de 1ère année</a>
                                </li>
                                <li role="presentation" class="dropdown-item">
                                    <a role="menuitem" href="../../pages/C_seeulater.php">Projet de 2ème année</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown nav-item <?php if($page===3) { ?>active <?php } ?>">
                            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown" role="button">
                        ...
                        <li class ="nav-item <?php if($page===4) { ?>active <?php } ?>">
                            <a href="../../pages/C_seeulater.php" class="nav-link"><span class="fa fa-envelope"></span>
                                Me contacter
                            </a>
                        </li> 
                    </ul>
