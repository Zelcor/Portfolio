            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <p> Passionné d'informatique depuis mon plus jeune âge, j'aime apprendre à faire de nouvelles choses avec les outils qui m'entourent.
                        Un passioné de technologie ? Oui carrément ! Mais j'aimerais maintenant approfondir mes connaissances!
                        Après mon bac S, le BTS SIO s'est présenté comme une évidence.
                        Avec 62% d'Informatique "pure" je savais que cette formation allait me servir de tramplin afin pour poursuivre dans cette voie et atteindre mon objectif qui est : devenir ingénieur informaticien !
                    </p>
                    <p>
                ...
                <div class="col-lg-4">
                    ...
                    <p> En fin de premier semestre, on a du choisir notre option. "Solutions Logicielles et Applications Métiers" est l'option qui m'a séduit&nbsp;! Travailler en équipe à la satisfaction de besoins d'un client, définir des spécifications,
                        ...
                        données sous MySQL, réalisation de composants logiciels avec Symfony, gestion de projet, méthodes agiles... J'étais sûr que ça serait fait pour moi !
                    </p>
                    <p>
