<?php if($page !==1){ ?> </div> <?php } ?>
    ...
    <footer class="sticky-bottom">
        <div class="container">
                ...
                <div class="col-lg-4">
                    ...
                    <div id="bts-sio" class="collapse multi-collapse">
                        <p> Passionné d'informatique depuis mon plus jeune âge, j'aime apprendre à faire de nouvelles choses avec les outils qui m'entourent.
                            ...
                            Avec 62% d'Informatique "pure" je savais que cette formation allait me servir de tremplin afin pour poursuivre dans cette voie et atteindre mon objectif qui est : devenir ingénieur informaticien !
                        </p>
                    </div>
            ...
            <hr>
            <p class="text-center" id="copyright">© Clément LOZE - <?php $year = date("Y"); echo($year) ?></p>
        </div>
    </footer>
</html>