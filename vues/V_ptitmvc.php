    <div class="row center">
        <div class="jumbotron" id="jumbotron">
            <section class="jumbotron text-center center shadow">
                <div class="container">
                    <h1 class="jumbotron-heading">TP MonPetitMVC</h1>
                    <p class="lead text-muted">
                        Cette activité m'a permis de mieux concevoir l'architecture MVC, de plus j'ai découvert l'Ajax !
                    </p>
                </div>
                <div class="container">
                    <div class="row">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a role="button" class="btn btn-primary" href="#">Projet GSB (bientôt) ↣</a>
                </div>
            </section>
        </div>
    </div>